  ...
  return (
    ...
    <div className="hs-carousel relative overflow-hidden w-full min-h-96 bg-white rounded-lg">
        ...
        <div className="flex flex-row items-center gap-x-2 px-2">
            <div className="hs-carousel-pagination-item shrink-0 border border-gray-200 rounded-md overflow-hidden cursor-pointer w-37.5 h-12.5 hs-carousel-active:border-blue-400 dark:border-neutral-700">
