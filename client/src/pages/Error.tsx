  ...
  <main id="content">
    <div className="text-center py-10 px-4 sm:px-6 lg:px-8">
      ...
      <div className="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
        <a className="w-full sm:w-auto py-3 px-4 inline-flex justify-center items-center gap-x-2 text-sm font-medium rounded-lg border border-transparent bg-base-200 text-white hover:bg-base-300 focus:outline-hidden focus:bg-base-300/50 disabled:opacity-50 disabled:pointer-events-none" href="/">
